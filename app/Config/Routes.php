...
$routes->get('/pemesanan/(:num)', 'ReservasiController::createKamar/$1');
$routes->post('/pemesanan/(:num)', 'ReservasiController::storeKamar/$1');
$routes->get('/pemesanan', 'ReservasiController::createKamarMultiple');
$routes->post('/pemesanan', 'ReservasiController::storeKamarMultiple');
